...
<body>
    <form id="frmDocHistoryReceive" showprocess="True" method="post" runat="server" con="SQLConnectionString"
    autodata="TRUE" formsetting="FormSettings" formdbtype="SQL" loginuser="LoginUser"
    userfield="Indx" searchgrid="gdList" advpanel="palSearch" searchbutton="btnSearch">
    <div class="bar_top">
        <div class="fr">
        </div>
    ...
    <div id="main_right" style="bottom: 0px; display: block; overflow: auto;">
        <div class="buttonBar">
            <cc1:ButtonEx ID="btnSearch" runat="server" Text="搜索" CssClass="FlatButton" CommandName="Search|S|SQL" CommandArgument="SearchTableS|SearchRes"></cc1:ButtonEx>
            <cc1:ButtonEx ID="btnSettings" runat="server" CssClass="FlatButton" OnClientClick="ShowSetting();return false;" Text="台帐设置"></cc1:ButtonEx>
            <cc1:ButtonEx ID="ButtonEx1" runat="server" Text="添加到下载" CssClass="FlatButton" CommandName="savedownlaod" CommandArgument="SearchRes|selected = 1|gdList" Width="85px"></cc1:ButtonEx>
        </div>
                ...
                <div id="p1">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="SearchTextCss">
                                <cc1:TextBoxEx ID="Textboxex2" runat="server" TextField="接收方式" TextTable="SearchTableS"
                                    CssClass="FlatTextBox"></cc1:TextBoxEx>
                            </td>
                            <td class="SearchLableCss">
                                接收时间：
                            ...
                            <td class="SearchTextCss">
                                <cc1:TextBoxEx ID="Textboxex3" runat="server" TextField="接收时间" TextTable="SearchTableS"
                                    CssClass="FlatTextBox"></cc1:TextBoxEx>
                            </td>
                            <td class="SearchLableCss">
                                接收状态:
                            ...
                            <td class="SearchTextCss">
                                <cc1:TextBoxEx ID="Textboxex6" runat="server" TextField="接收状态" TextTable="SearchTableS"
                                    CssClass="FlatTextBox"></cc1:TextBoxEx>
                            </td>
                        </tr>
                    </table>
