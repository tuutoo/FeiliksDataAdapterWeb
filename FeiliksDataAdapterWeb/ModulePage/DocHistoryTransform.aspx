...
<body>
    <form id="frmDocHistoryTransform" showprocess="True" method="post" runat="server"
                ...
                <div id="p1">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="SearchTextCss">
                                <cc1:TextBoxEx ID="Textboxex2" runat="server" TextField="转换模板" TextTable="SearchTableS"
                                    CssClass="FlatTextBox"></cc1:TextBoxEx>
                            </td>
                            <td class="SearchLableCss">
                                转换时间：
                            ...
                            <td class="SearchTextCss">
                                <cc1:TextBoxEx ID="Textboxex3" runat="server" TextField="转换时间" TextTable="SearchTableS"
                                    CssClass="FlatTextBox"></cc1:TextBoxEx>
                            </td>
                            <td class="SearchLableCss">
                                转换状态:
                            ...
                            <td class="SearchTextCss">
                                <cc1:TextBoxEx ID="Textboxex6" runat="server" TextField="转换状态" TextTable="SearchTableS"
                                    CssClass="FlatTextBox"></cc1:TextBoxEx>
                            </td>
                        </tr>
                    </table>
