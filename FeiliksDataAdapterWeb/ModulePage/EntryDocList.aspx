...
<body>
     ...
     <form showprocess="True" id="frmEntryDocList" method="post" runat="server" con="SQLConnectionString"
    ...
    <div id="main_right" style="bottom: 0px; display: block; overflow: auto;">
        <div class="buttonBar">
          <a href="EntryInfo.aspx"  class="FlatButton">新增</a> 
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="SearchTextCss">
                                <cc1:TextBoxEx ID="Textboxex5" runat="server" TextField="预录入号" TextTable="SearchTableS"
    ...
    <asp:HiddenField ID="hid_goodname" runat="server" />
