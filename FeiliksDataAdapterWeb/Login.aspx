...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Resource/CSS/common.css" />
     <style>
        ...
        .style2
        {
         ...
         .FlatButtonTT { background: url(Resource/IMG/login_srue.png) repeat-x 0 0; border-style: none;
                border-color: inherit;
                border-width: 0px;
                height: 32px;
                color: #ffffff;
 ...
 .FlatButtonTT0 { background: url(Resource/IMG/login_cancle.png) repeat-x 0 0; border-style: none;
                border-color: inherit;
                border-width: 0px;
                height: 32px;
                font-size: 14px;
...
<body>
    ...
    con="SQLConnectionString" runat="server" employeeallow="EmployeeAllow" allowid="Employee"
    allowcheck="ID" CheckLogin="False">
    <div class="warp">
                ...
                <tr>
                    <td style="padding-left: 208px;" class="style1">
                        ...
                        <span style="width: 20px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                            <a  href="#" onclick="ChangePwdOpen()" style="color: #ffffff; text-decoration: underline;">>>&nbsp;修改密码</a>
  ...
  <div id="ly" style="position: absolute; top: 0px; filter: alpha(opacity=60); background-color: #777; z-index: 2; left: 0px; display: none;" >
        ...
        <div id="Layer2" align="center" style="position: absolute; z-index: 3; left: 30%; top: 38%; background-color: #fff; display: none; background:url(Resource/IMG/login_changPwd.png) no-repeat ;" onkeydown="PingBi()">
            <table width="500" height="330">
                <tr>
                    <td  align="left" valign="top" colspan="2"  style=" height:40px;">
                       <div style=" margin-top:14px; margin-left:20px; font-size:14px; color:#ffffff;">修改密码</div> 
                        <div style=" margin-left:460px;margin-top:-22px;background:url(Resource/IMG/PwdClose.png) no-repeat ; width:22px; height:22px;" onclick="Btn_CloseDiv();">
                        </div>
                        </td>
                </tr>
                <tr>
                    <td align="right" style=" width:200px;">用户名：
                    </td>
                    <td align="left">
                        <input id="userid" type="text" name="txtuserid" runat="server" onkeydown="PingBi()" /><span style="color: red">&nbsp;*</span>
                    </td>
                </tr>
                <tr>
                    <td align="right" style=" width:200px;">原密码：
                    </td>
                    <td align="left">
                        <asp:TextBox ID="passwd" runat="server" TextMode="Password" onkeydown="PingBi()"></asp:TextBox><span style="color: red">&nbsp;*</span>
                    </td>
                </tr>
                <tr id="tr1" runat="server" visible="true">
                    <td align="right" style=" width:200px;">新密码：
                    </td>
                    <td align="left">
                        <input id="txtNewPwd" type="password" name="txtNewpwd" runat="server" onkeydown="PingBi()"/><span style="color: red">&nbsp;*</span>
                    </td>
                </tr>
                <tr id="tr2" runat="server" visible="true">
                    <td align="right" style=" width:200px;">确认新密码：
                    </td>
                    <td align="left">
                        <input id="txtConfirmPwd" type="password" name="txtConfirmPwd" runat="server" onkeydown="PingBi()"/><span style="color: red">&nbsp;*</span>
                    </td>
                </tr>
               
                <tr>
                    <td colspan="2"  style=" height:50px;">
                        <asp:Button ID="btnChangePwd" 
                            OnClientClick="Btn_ConfimChange();" runat="server" CssClass="FlatButtonTT"  
                            Text="确定"  Width="100px" Height="32px"></asp:Button>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="BtnClose" runat="server" Text="取消" 
                         CssClass="FlatButtonTT0" 
                        Width="100px" Height="32px"  OnClientClick="Btn_CloseDiv();" />
               </td>
